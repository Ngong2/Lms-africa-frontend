  ...
  const handleSubmit = async () => {
    ...
    try {
      if (method === 'Flutterwave') {
        const res = await axios.post('https://backend-ilw9.onrender.com/api/flutterwave/payment', {
          name,
          email,
          amount: amount,
          currency: 'KES', 
        ...
        const res = await axios.post('https://backend-ilw9.onrender.com/api/mpesa/payment', {
          phone,
          amount: amount,
        ...
        const res = await axios.post('https://backend-ilw9.onrender.com/api/stripe/payment', {
          name,
          email,
          amount: amount,
          currency: 'KES', 
